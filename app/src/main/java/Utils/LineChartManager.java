...
public class LineChartManager {
    ...
    private void initLineChart() {
        ...
        //设置动画效果 Erro:Animators may only be run on Looper threads
...
//        lineChart.animateX(1000, Easing.EasingOption.Linear);
    ...
    public void showLineChart(List<Float> xAxisValues, List<Float> yAxisValues, String label, int color) {
       ...
       // leftAxis.setLabelCount(15,false);
        ...
        //为什么不直接将dataSets作为参数？判断数据是否正确
        LineData data = new LineData(dataSets);
        //lineChart.setData(dataSets); Answer:LineChart extends BarLineChartBase<LineData>
    ...
    public void setYAxis(float max, float min, int labelCount) {
        ...
        leftAxis.setLabelCount(labelCount/2, false);

        rightAxis.setAxisMaximum(max);
        rightAxis.setAxisMinimum(min);
        rightAxis.setLabelCount(labelCount/2, false);
